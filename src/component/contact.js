        ...
        return (
            <Layout style={{ backgroundColor: just_black }}>
                ...
                <Row type="flex" justify="center">
                    <Title style={{ color: just_white,padding: 25 }} level={1}>Contact Us</Title>
                </Row>

                <Row type="flex" justify="center">
                    <Text style={{color:just_white,fontSize:16}}>Hotline :</Text>
                    <Text style={{color:just_white,fontSize:16}}>+94 (71) 910 1304</Text>
                </Row>
                <Row type="flex" justify="center">
                    <Text style={{color:just_white,fontSize:16}}>Web :</Text>
                    <Text style={{color:just_white,fontSize:16}}>www.assignmentguide.lk</Text>
                </Row>
                <Row type="flex" justify="center">
                    <Text style={{color:just_white,fontSize:16}}>Email :</Text>
                    <Text style={{color:just_white,fontSize:16}}>assignmentguide2015@gmail.com</Text>
                </Row>

                <Row type="flex" justify="center" style={{ backgroundColor: just_black, paddingBottom: '25vh' }}>
                    <Row style={{ paddingLeft: 50, paddingTop: 30, paddingBottom: 80, width: ScreenWidth, backgroundColor: just_black }} type={'flex'} justify={'center'}>
                        <form method="POST" action="https://formspree.io/assignmentguide2015@gmail.com">
                            <Row type={'flex'} justify={'space-between'} style={{ paddingBottom: 20, width: ScreenWidth / 2.8 }}>
                                <Col>
                            ...
                            <Row type={'flex'} justify={'start'} style={{ paddingBottom: 20, width: ScreenWidth / 2.8 }}>
